...
<img width="1917" height="963" alt="print" src="https://github.com/user-attachments/assets/f955115f-36fd-4ee2-b7d4-bddb92f0543e" />
...
Componente reutilizável de campo de texto. Recebe via `props` os atributos `label`, `name`, `value`, `onChange` e demais propriedades repassadas ao `<input>` através do operador *spread* `...inputProps`. Não possui estado próprio.
